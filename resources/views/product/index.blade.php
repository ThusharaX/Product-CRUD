                    ...
                    <tbody class="block md:table-row-group">
                        @foreach ($products as $key => $product)
                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                ...
                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                        class="inline-block w-1/3 md:hidden font-bold">name</span>{{ $product->name }}
                                </td>
                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                ...
                                @if ($product->status == 'inactive')
                                    <td
                                        class="p-2 md:border md:border-grey-500 text-left block md:table-cell text-red-700 font-bold">
                                ...
                                @else
                                    <td
                                        class="p-2 md:border md:border-grey-500 text-left block md:table-cell text-green-700 font-bold">
